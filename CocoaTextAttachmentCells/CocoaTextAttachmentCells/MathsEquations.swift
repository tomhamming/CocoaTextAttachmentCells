...
precedencegroup PlumHeadPrecedence {
    associativity: left
    lowerThan: CastingPrecedence
}

infix operator ^- : PlumHeadPrecedence
...
struct MathEquations {
    ...
    static func s(s: MathSymbolContentType, sub: MathExpr? = nil, sup: MathExpr? = nil) -> MathSymbol {
        return MathSymbol(symbol: s, symSubscript: sub, symSuperscript: sup)
    }
    
    static func se(s: MathSymbolContentType, sub: MathExpr? = nil, sup: MathExpr? = nil) -> MathExpr {
        let a = MathSymbol(symbol: s, symSubscript: sub, symSuperscript: sup)
        return MathExpr.Symbol(sym: a)
    }
    
    static func se(s: String, sub: MathExpr? = nil, sup: MathExpr? = nil) -> MathExpr {
        let sym = v(t: s)
    ...
    static func pythagorasTheorum() -> (NSAttributedString,MathExpr,NSAttributedString) {
        let pretxt = NSAttributedString(string: "Pythagoras's Theorum: ", attributes: [.font: NSFont.boldSystemFont(ofSize: 18)])
    ...
    static func logarithms() -> (NSAttributedString,MathExpr,NSAttributedString) {
        let pretxt = NSAttributedString(string: "Logarithms:      ", attributes: [.font: NSFont.boldSystemFont(ofSize: 18)])
    ...
    static func calculus() -> (NSAttributedString,MathExpr,NSAttributedString) {
        ...
        let pretxt = NSAttributedString(string: "Calculus:      ", attributes: [.font: NSFont.boldSystemFont(ofSize: 18)])
    ...
    static func lawOfGravity() -> (NSAttributedString,MathExpr,NSAttributedString) {
        ...
        let pretxt = NSAttributedString(string: "Law of Gravity:      ", attributes: [.font: NSFont.boldSystemFont(ofSize: 18)])
    ...
    static func rootMinusOne() -> (NSAttributedString,MathExpr,NSAttributedString) {
        ...
        let pretxt = NSAttributedString(string: "The square root of minus one:      ", attributes: [.font: NSFont.boldSystemFont(ofSize: 18)])
    ...
    static func polyhedra() -> (NSAttributedString,MathExpr,NSAttributedString) {
        ...
        let pretxt = NSAttributedString(string: "Euler's formula for polyhedra:      ", attributes: [.font: NSFont.boldSystemFont(ofSize: 18)])
    ...
    static func normalDistribution() -> (NSAttributedString,MathExpr,NSAttributedString) {
        let pretxt = NSAttributedString(string: "Normal Distribution:      ", attributes: [.font: NSFont.boldSystemFont(ofSize: 18)])
    ...
    static func waveEquation() -> (NSAttributedString,MathExpr,NSAttributedString) {
        let pretxt = NSAttributedString(string: "Wave Equation:      ", attributes: [.font: NSFont.boldSystemFont(ofSize: 18)])
    ...
    static func fourierTransform() -> (NSAttributedString,MathExpr,NSAttributedString) {
        let pretxt = NSAttributedString(string: "Fourier Transform:      ", attributes: [.font: NSFont.boldSystemFont(ofSize: 18)])
    ...
    static func navierStokes() -> (NSAttributedString,MathExpr,NSAttributedString) {
        let pretxt = NSAttributedString(string: "Navier-Stokes Equation:      ", attributes: [.font: NSFont.boldSystemFont(ofSize: 18)])
    ...
    static func maxwells() -> (NSAttributedString,MathExpr,NSAttributedString) {
        let pretxt = NSAttributedString(string: "Maxwell's Equations:      ", attributes: [.font: NSFont.boldSystemFont(ofSize: 18)])
    ...
    static func thermo() -> (NSAttributedString,MathExpr,NSAttributedString) {
        let pretxt = NSAttributedString(string: "Second Law of Thermodynamics:      ", attributes: [.font: NSFont.boldSystemFont(ofSize: 18)])
    ...
    static func relativity() -> (NSAttributedString,MathExpr,NSAttributedString) {
        let pretxt = NSAttributedString(string: "Relativity:      ", attributes: [.font: NSFont.boldSystemFont(ofSize: 18)])
    ...
    static func schrodinger() -> (NSAttributedString,MathExpr,NSAttributedString) {
        let pretxt = NSAttributedString(string: "Schrodingers's Equation:      ", attributes: [.font: NSFont.boldSystemFont(ofSize: 18)])
    ...
    static func infoTheory() -> (NSAttributedString,MathExpr,NSAttributedString) {
        let pretxt = NSAttributedString(string: "Information Theory:      ", attributes: [.font: NSFont.boldSystemFont(ofSize: 18)])
    ...
    static func chaos() -> (NSAttributedString,MathExpr,NSAttributedString) {
        let pretxt = NSAttributedString(string: "Chaos Theory:      ", attributes: [.font: NSFont.boldSystemFont(ofSize: 18)])
    ...
    static func blackScholes() -> (NSAttributedString,MathExpr,NSAttributedString) {
        let pretxt = NSAttributedString(string: "Black-Scholes Equation:      ", attributes: [.font: NSFont.boldSystemFont(ofSize: 18)])
